...
class Analysis:
    ...
    * fields (`FieldAnalysis`)
    ...
    def __init__(self, vm=None):
        ...
        self.methods = dict()
        # A dict with the map of functions-api
        self.map_method_api = None
    ...
    def load_specific_api(self, apilevel=None):
        """
        Load specific dict of methods by API level.

        :param apilevel: the requested API level or None for default
        :return: None
        """
        self.map_method_api = load_api_specific_resource_module('api_permission_mappings', apilevel)
